...
import com.androidnative.gcm.PictureLoadingTaskListener;
...
public class AN_PictureLoadingListener implements PictureLoadingTaskListener {
	...
	public AN_PictureLoadingListener(int requestId, Builder builder, NotificationManager manager, PendingIntent intent, String title, String message, String data) {
